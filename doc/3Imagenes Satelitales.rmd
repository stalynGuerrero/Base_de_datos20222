...
knitr::include_graphics("Imagen/lights.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Imagen/query.png")
```
...
rgee::ee_install_set_pyenv(py_path = rgee_environment_dir, py_env = "rgee_py"); 2
...
```{r echo=FALSE, out.width = "700px", out.height="350px",fig.align='center'}
knitr::include_graphics("imagen/Descriptivo_deluces.bmp")
```
...
```{r, echo=FALSE}
temp <- left_join(COL_DEPTO[c("DPTO", "NOMBRE_DPT")],COL_luces)
